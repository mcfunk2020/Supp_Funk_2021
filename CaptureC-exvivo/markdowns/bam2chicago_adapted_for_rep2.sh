...
echo "sorting .bedpe file..."
sort -k1,1 -k2,2n ${samplename}/${bamname}_mappedToBaits_baitOnRight.bedpe > ${samplename}/sorted.bedpe
awk '{if ($2 > $3) print $1"\t"$3"\t"$2"\t"$4"\t"$5"\t"$6"\t"$7"\t"$8"\t"$9"\t"$10"\t"$11"\t"$12"\t"$13"\t"$14; else print $1"\t"$2"\t"$3"\t"$4"\t"$5"\t"$6"\t"$7"\t"$8"\t"$9"\t"$10"\t"$11"\t"$12"\t"$13"\t"$14}' ${samplename}/sorted.bedpe > ${samplename}/sorted_new.bedpe
cp ${samplename}/sorted_new.bedpe ${samplename}/${bamname}_mappedToBaits_baitOnRight.bedpe
